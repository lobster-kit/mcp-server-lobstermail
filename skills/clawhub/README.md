...
- **MCP server on npm**: [`@lobsterkit/lobstermail-mcp`](https://www.npmjs.com/package/@lobsterkit/lobstermail-mcp)
- **SDK on npm**: [`@lobsterkit/lobstermail`](https://www.npmjs.com/package/@lobsterkit/lobstermail)
